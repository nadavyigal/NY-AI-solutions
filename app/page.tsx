      ...
      <section className="about-section" id="about" aria-labelledby="about-title">
        <div className="section-shell about-layout">
          ...
          <div className="copy-stack about-copy">
            ...
            <p>אני בעל תואר ראשון בכלכלה וניהול עסקים, עם ניסיון מקצועי בייעוץ, בנקאות וניהול סיכונים, ועם שתים־עשרה שנות ניסיון בניהול סוכנות ביטוח. לאורך השנים עסקתי בשיפור תהליכי עבודה ותוצאות, בנקודת החיבור שבין מערכות מידע, מערכות פיננסיות והעבודה העסקית היומיומית. הרקע הזה לימד אותי להסתכל על טכנולוגיה דרך שאלות עסקיות: מה הבעיה שאנחנו פותרים, מה הערך הצפוי, מה הסיכון, ואיך נדע שהפתרון באמת עובד.</p>
