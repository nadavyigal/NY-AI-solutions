...
function Home() {
  return (
    <main>
      ...
      <section className="main-page-link-section" aria-labelledby="main-page-link-title">
        <div className="section-shell main-page-link-card">
          <p className="section-label">רוצים להכיר את התמונה המלאה?</p>
          <h2 id="main-page-link-title">המשיכו לעמוד הראשי של NY AI Solutions</h2>
          <p>שם תוכלו לקרוא בהרחבה על הגישה, התהליך, הניסיון והמוצרים שבניתי.</p>
          <Link className="button button-primary" href="/">לעמוד הראשי ←</Link>
        </div>
      </section>
